...
#print(df.head)
sb.stripplot(x='Plates', y='Min', hue = 'profile', palette='RdYlGn',
             data=df, jitter=True)
plt.title('Strip plots for the max depth values: Mariana Trench bathymetry',
          fontsize=10, fontfamily='serif')
plt.legend(bbox_to_anchor=(1.14, .8), loc=1, borderaxespad=-4., ncol=2, 
           markerscale=.5, fancybox=True, shadow=True, mode='expand',
           title='Bathymetric \nProfiles:',
