...
#print(df.head)
sb.stripplot(x='Plates', y='slope_angle', hue = 'profile', palette='PiYG', data=df, jitter=True)
plt.title('Strip plots for the slope angle degree: Mariana Trench', fontsize=10, fontfamily='serif')
