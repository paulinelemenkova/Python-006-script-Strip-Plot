...
#print(df.head)
sb.stripplot(x='Plates', y='sedim_thick', hue = 'profile', palette='RdGy', data=df, jitter=True)
plt.title('Strip plots for the sediment thickness: Mariana Trench', fontsize=10, fontfamily='serif')
