...
plt.title(
          'Sunda Plate and Philippine Plate',
          fontsize=10, fontfamily='serif'
          )
plt.legend(
           title='Profiles', title_fontsize=8,
           bbox_to_anchor=(1.01, 0.01, 0.15, 0.99), loc="upper right",
...
plt.annotate(
             'B', xy=(0.03, .9), xycoords="axes fraction", fontsize=14,
             bbox=dict(boxstyle='round, pad=0.3', fc='w',
                       edgecolor='grey', linewidth=1, alpha=0.9)
             )
plt.subplots_adjust(bottom=0.15,top=0.85, right=0.80)
